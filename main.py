...
class MAIN:
    ...
    def draw_score(self):
        ...
        bg_rect = pygame.Rect(apple_rect.left, apple_rect.top, apple_rect.width
                              + score_rect.width + 6, apple_rect.height + 3)
...
class SNAKE:
    def __init__(self):
        ...
        self.fail_sound = pygame.mixer.Sound('Sound/fail.ogg')
...
# point to image of apple and convert it to python compatible image file
apple = pygame.image.load('Graphics/apple1.png').convert_alpha()
apple = pygame.transform.scale(apple, (cell_size, cell_size))

# font
game_font = pygame.font.Font('Font/04B_19.TTF', 25)
